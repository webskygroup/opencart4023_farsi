...
/* extension/persian_language/admin/view/template/dashboard/chart_info.twig */
class __TwigTemplate_14137d187ada062f4047d766c04c24fb extends Template
{
    private $source;
    private $macros = [];
...
\$('#range a').on('click', function (e) {
    ...
    \$.ajax({
        type: 'get',
        url: 'index.php?route=extension/persian_language/dashboard/chart.chart&user_token=";
        // line 26
...
";
    ...
    {
        return "extension/persian_language/admin/view/template/dashboard/chart_info.twig";
    }
    ...
    {
        return new Source("", "extension/persian_language/admin/view/template/dashboard/chart_info.twig", "C:\\wamp64\\www\\opencart-4.0.2.3_farsi\\extension\\persian_language\\admin\\view\\template\\dashboard\\chart_info.twig");
    }
}
